...
batches_y, batches_x, test_batch_y, test_batch_x = get_data(data_path, batch_size, wavelet=True)
...
# divide data into 400 points chunks
# scramble
# then partitiion into training and test set
