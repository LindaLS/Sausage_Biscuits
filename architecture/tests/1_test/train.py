...
batch_y_i0, batch_x_i0 = get_batch_from_raw_data_normalized(data_i0, action_map, [0])
batch_y_i1, batch_x_i1 = get_batch_from_raw_data_normalized(data_i1, action_map, [0])
batch_y_i2, batch_x_i2 = get_batch_from_raw_data_normalized(data_i2, action_map, [0])
batch_y_i3, batch_x_i3 = get_batch_from_raw_data_normalized(data_i3, action_map, [0])
...
batch_y_t0, batch_x_t0 = get_batch_from_raw_data_normalized(data_t0, action_map, [0])
batch_y_t1, batch_x_t1 = get_batch_from_raw_data_normalized(data_t1, action_map, [0])
...
batch_y_p0, batch_x_p0 = get_batch_from_raw_data_normalized(data_p0, action_map, [0])
batch_y_p1, batch_x_p1 = get_batch_from_raw_data_normalized(data_p1, action_map, [0])
batch_y_p2, batch_x_p2 = get_batch_from_raw_data_normalized(data_p2, action_map, [0])
...
batch_y_test0, batch_x_test0 = get_batch_from_raw_data_normalized(data_test0, action_map, [0,2,4])
batch_y_test1, batch_x_test1 = get_batch_from_raw_data_normalized(data_test1, action_map, [0,2,4])
